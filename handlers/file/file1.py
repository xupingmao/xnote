...
class FileHandler(BaseHandler):
    ...
    def addRequest(self):
        ...
        try:
            if name != '':
                ...
                raise web.seeother("/file_edit?name=%s" % quote(name))
    ...
    def updateContentRequest(self):
        ...
        raise web.seeother("/file_edit?id=" + id)
    ...
    def renameRequest(self):
        ...
        if old_record is None:
            ...
            self.render("file-edit.html", file=old_record, content = old_record.get_content(), date2str=date2str)
