...
class TestMain(BaseTestCase):
    ...
    def test_timeline_api(self):
        ...
        assert_json_request_success(self, "/api/v1/note/timeline")
        assert_json_request_success(self, "/api/v1/note/timeline?type=public")
        assert_json_request_success(self, "/api/v1/note/timeline?type=sticky")
        assert_json_request_success(self, "/api/v1/note/timeline?type=removed")
        assert_json_request_success(self, "/api/v1/note/timeline?type=archived")
        assert_json_request_success(self, "/api/v1/note/timeline?type=all")
        assert_json_request_success(self, "/api/v1/note/timeline?type=plan")
        assert_json_request_success(self, "/api/v1/note/timeline?type=list")
        assert_json_request_success(self, "/api/v1/note/timeline?type=gallery")
        assert_json_request_success(self, f"/api/v1/note/timeline?type=default&parent_id={default_group_id}")
        assert_json_request_success(self, u"/api/v1/note/timeline?type=search&key=xnote中文")
    ...
    def test_copy_markdown(self):
        ...
        resp = json_request_return_dict("/api/v1/note/content?id=%s" % id)
        self.assertEqual(True, resp["success"])
    ...
    def test_note_share_group_to(self):
        ...
        try:
            ...
            result = json_request_return_dict(f"/api/v1/note/timeline?_type=json&type=default&parent_id={group_id}")
            data = result.get_list("data", [])
            assert len(data) == 1
            
            no_auth_result = json_request_return_dict(f"/api/v1/note/timeline?_type=json&type=default&parent_id={unauthorized_id}")
    ...
    def test_note_search_name(self):
        ...
        result = json_request_return_dict("/api/v1/note/timeline?type=search&key=name")
    ...
    def test_note_api_group(self):
        json_data = json_request_return_dict("/api/v1/note/group?list_type=all")
