...
def main():
    if osutil.is_command_exists("cloc"):
        ...
        os.system("code-count-lines xnote handlers xutils xnote_migrate static/js/ tools --exclude py3.8 py3.7 py3.6 lib static/lib data* htmlcov dist build tmp *.build.js")
