# encoding=utf-8
# Dropdown 示例 tab，对应 /examples/example/dropdown
...
class DropdownExampleHandler:
    ...
    def GET(self):
        ...
        xmanager.add_visit_log(user_name, "/examples/example/dropdown")
...
xurls = (
    r"/examples/example/dropdown", DropdownExampleHandler,
)
