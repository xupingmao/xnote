...
INNER_TOOLS = [
    ...
    note_plugin("上传管理", "/fs_upload/manage", "fa-upload", visible_in_list=False),
    note_plugin("我的文件", "/fs_upload/manage?source=file", "fa-upload", visible_in_list=False),
