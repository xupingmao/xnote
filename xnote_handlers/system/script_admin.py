...
class ExecuteHandler:
    ...
    def POST(self):
        name = xutils.get_argument_str("name")
        content = xutils.get_argument_str("content")
        arg_path = xutils.get_argument_str("path")
...
class ListHandler:
    ...
    def GET(self):
        ...
        name  = xutils.get_argument_str("name", "")
        error = xutils.get_argument_str("error", "")
        dirname = xconfig.SCRIPTS_DIR
...
class RenameHandler:
    ...
    @xauth.login_required("admin")
    def POST(self):
        oldname = xutils.get_argument_str("oldname")
        newname = xutils.get_argument_str("newname")
